        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               /* map=new HashMap<String, Object>();
                ...
                //Here I did is created a new object and then store the full name, phone, ic and also carplate
                //because I want to store a list of carplate so I try to use Arraylist
                Account account = new Account(fullname, phone, ic,carPlate);
                if(user!=null) {
