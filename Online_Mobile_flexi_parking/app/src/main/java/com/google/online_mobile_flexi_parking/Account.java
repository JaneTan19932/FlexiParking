...
public class Account {
  ...
  /*  public Account(String fullname, String phone, String carplate1, String IC)
    ...
    public Account(String fullname, String phone, String IC,List<String> carPlate0)
    {
        this._Phone=phone;
        this._CarPlate0=carPlate0;
        this._FullName=fullname;
        this._IC=IC;
    }
/*    public Account(String fullname, String phone, List carplate, String IC)
   ...
   /* public Account(String carplate1,String carplate2,String carplate3)
    ...
    public void set_CarPlate0(List<String> carPlate0)
    {
        this._CarPlate0 = carPlate0;
    }

    public List<String> get_CarPlate0()
    {
        return _CarPlate0;
    }
    ...
    public void set_Key(String key){this._Key=key;
    }
